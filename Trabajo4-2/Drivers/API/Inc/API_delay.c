...
// para usarla dentro de main se crea una vairable de tipo delay_t TIMMER1;
// se inicializa con SysDelatInit ( & TIMMER1 , XXXX) -> valor del delay en ms
// El llamado se hace con SysDelayRead ( & TIMMER1)
// devuelve true cuando el tiempo se cumple y se desactiva
// con el siguiente llamado se recarga y reinicia el conteo de tiempo en ms.
