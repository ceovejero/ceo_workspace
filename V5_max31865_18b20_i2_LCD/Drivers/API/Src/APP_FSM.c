...
//#define SENSOR_CS1_GPIO_Port SENSOR_CS1_GPIO_Port
...
void APP_FSM_init()
{
		...
		SPI1_Init();
		//CS_GPIO_Init();
		Max31865_init(&pt100,&max3185_spi,SENSOR_CS1_GPIO_Port,SENSOR_CS1_Pin,4,50);
						...
						if ((prev_tempC != tempC)||(prevState!=DISPLAY_APP_STATE))
						 	 {
								...
								lcd_put_cur(3, 1);
								sprintf(lcdString, "Temp: %3.3f C",pt100Temp);
								lcd_send_string (lcdString);
