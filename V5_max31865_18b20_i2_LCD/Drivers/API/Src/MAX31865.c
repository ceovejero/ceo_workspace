...
#define SENSOR_CS1_Pin GPIO_PIN_12
#define SENSOR_CS1_GPIO_Port GPIOF
...
void SPI1_Init(void)
{
	...
	max3185_spi.Instance = SPI1;
	max3185_spi.Init.Mode = SPI_MODE_MASTER;
	max3185_spi.Init.Direction = SPI_DIRECTION_2LINES;
	max3185_spi.Init.DataSize = SPI_DATASIZE_8BIT;
	max3185_spi.Init.CLKPolarity = SPI_POLARITY_LOW;
	max3185_spi.Init.CLKPhase = SPI_PHASE_2EDGE;
	max3185_spi.Init.NSS = SPI_NSS_SOFT;
	max3185_spi.Init.BaudRatePrescaler = SPI_BAUDRATEPRESCALER_64;
	max3185_spi.Init.FirstBit = SPI_FIRSTBIT_MSB;
	max3185_spi.Init.TIMode = SPI_TIMODE_DISABLE;
	max3185_spi.Init.CRCCalculation = SPI_CRCCALCULATION_DISABLE;
	max3185_spi.Init.CRCPolynomial = 10;
...
//{
//	 GPIO_InitTypeDef CS_GPIO_InitStruct = {0};


	  /*Configure GPIO pin : SENSOR_CS1_Pin */
//	  CS_GPIO_InitStruct.Pin = SENSOR_CS1_Pin;
//	  CS_GPIO_InitStruct.Mode = GPIO_MODE_OUTPUT_PP;
//	  CS_GPIO_InitStruct.Pull = GPIO_NOPULL;
//	  CS_GPIO_InitStruct.Speed = GPIO_SPEED_FREQ_LOW;
//	  HAL_GPIO_Init(SENSOR_CS1_GPIO_Port, &CS_GPIO_InitStruct);

	  /*Configure GPIO pin Output Level */
//	  	  HAL_GPIO_WritePin(SENSOR_CS1_GPIO_Port, SENSOR_CS1_Pin, GPIO_PIN_RESET);
